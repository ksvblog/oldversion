                ...
                value: function (e, t) {
                  ...
                  if (void 0 !== i && null !== i) {
                    ...
                    if ('string' == typeof i) {
                      ...
                      var x = f.search(i);
                      if (
                        (this._log('Full text: "' + i + '", score: ' + x.score),
              ...
              },
              {
                ...
                value: function (e, t) {
                  ...
                  for (var r = 0, n = t.length; r < n; r += 1) {
                    for (
                      var o = t[r].output, i = o.length, a = 0, s = 1, c = 0;
                      c < i;
                      c += 1
                    ) {
                ...
                value: function (e) {
                  ...
                  for (var n = 0, o = e.length; n < o; n += 1) {
                    ...
                    if (
                      ...
                      for (
                        var a = { item: i.item }, s = 0, c = r.length;
                        s < c;
                        s += 1
                      )
                        r[s](i, a);
